...
func sendReport(t *testing.T, r *tcpSNIReporter, summary TCPSummary, response []byte, responseErr error) string {
...
func runSuccessTest(t *testing.T, summary TCPSummary) string {
	r := tcpSNIReporter{}
